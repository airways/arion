...
class UserListField extends BaseDomainField implements IDomainField {
    ...
    public function render($filterMode=false, $filterValue=false) {
        // Get data saved for us by UserListMeta->loadMeta()
        $users = $this->fieldModel->getMeta()->getUsers();
        ...
        return $this->view->render('fields/userlist.html.twig', $vars);
    }
